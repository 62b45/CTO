...
describe('CombatService', () => {
  ...
  describe('simulateCombat', () => {
    ...
    it('should restore player health after combat', () => {
      ...
      expect(result.updatedPlayerStats.health).toBe(result.updatedPlayerStats.maxHealth);
    });
    ...
    it('should throw error for non-existent enemy template', () => {
      const invalidRequest = { ...mockRequest, enemyTemplateId: 'non_existent' };
  ...
  describe('getCombatLogs', () => {
    it('should return null for non-existent combat session', () => {
      const logs = combatService.getCombatLogs('player1', 'non_existent_session');
